...
- Developer guide for using `wp_ai_client_prompt()` with Azure AI Foundry.
...
- AI plugin connector detection on WordPress 7.0 RC3 by pointing the hidden sentinel connector at its synced setting.

## [1.2.2] - 2026-04-29

### Added

- `wpai_preferred_text_models` filter to prepend Azure text-generation models to the AI plugin preferred list.

## [1.2.1] - 2026-04-08

### Fixed

- PHP syntax compatibility with WordPress.org SVN linter (removed typed constants).
...
- Plugin icon (`icon.svg`) for WordPress.org plugin directory.
- Updated installation instructions for WordPress.org.
...
- GitHub Actions release workflow content-length mismatch error.
...
[1.1.1]: https://github.com/soderlind/azure-ai-foundry/compare/1.1.0...1.1.1
[1.1.0]: https://github.com/soderlind/azure-ai-foundry/compare/1.0.0...1.1.0
[1.0.0]: https://github.com/soderlind/azure-ai-foundry/compare/0.3.3...1.0.0
[0.3.3]: https://github.com/soderlind/azure-ai-foundry/compare/0.3.2...0.3.3
[0.3.2]: https://github.com/soderlind/azure-ai-foundry/compare/0.3.1...0.3.2
[0.3.1]: https://github.com/soderlind/azure-ai-foundry/compare/0.3.0...0.3.1
[0.3.0]: https://github.com/soderlind/azure-ai-foundry/compare/0.2.0...0.3.0
[0.2.0]: https://github.com/soderlind/azure-ai-foundry/compare/0.1.0...0.2.0
[0.1.0]: https://github.com/soderlind/azure-ai-foundry/releases/tag/0.1.0
